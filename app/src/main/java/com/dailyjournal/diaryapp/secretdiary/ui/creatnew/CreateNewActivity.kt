...
class CreateNewActivity : BaseActivity2<ActivityCreatNewBinding>(), SaveRecorderListener {
    ...
    override fun initView() {
        ...
        if (SharePrefRemote.get_config(
            ...
            if (adIds.isNotEmpty()) {
                Admob.getInstance().initRewardAds(this, adIds.first())
            }
        }
        showUiADS()
    ...
    override fun viewListener() {
        ...
        binding.btnHastag.tap {
            if (!SharePrefUtils.isCheckAdsTAG(this) && SharePrefRemote.get_config(
                ...
                val adIds = AdmobApi.getInstance().getListIDByName("rewarded_edit")
                if (adIds.isNotEmpty()) {
                    Admob.getInstance().loadAndShowReward(this@CreateNewActivity,
                        this@CreateNewActivity,
                        adIds.first(),
                        object : RewardCallback {
                            override fun onEarnedReward(rewardItem: RewardItem?) {
                                SharePrefUtils.setCheckAdsTAG(this@CreateNewActivity, true)
                                showUiADS()
                                function = "hastag"
                                iconSelected()
                                hastag()
            ...
            LogEven.logEvent(this, "hastag_click", Bundle())

        }

        binding.btnSave.tap {
            LogEven.logEvent(this, "save_click", Bundle())
        ...
        binding.ivDateTime.tap {
            LogEven.logEvent(this, "create_calender_click", Bundle())
            clearIconSelected()
            dateTime()
        }

        binding.ivEmoji.tap {
            LogEven.logEvent(this, "status_click", Bundle())
                    ...
                    Admob.getInstance().loadAndShowReward(this@CreateNewActivity,
                        ...
                        object : RewardCallback {
                            override fun onEarnedReward(rewardItem: RewardItem?) {
                                clearIconSelected()
                                statusEmoji()
                                SharePrefUtils.setCheckAdsEMOIJ(this@CreateNewActivity, true)
                                showUiADS()
                            }
        ...
        binding.btnImages.tap {
            LogEven.logEvent(this, "image_click", Bundle())
                    ...
                    if (adIds.isNotEmpty()) {
                        Admob.getInstance().loadAndShowReward(this@CreateNewActivity,
                            ...
                            object : RewardCallback {
                                ...
                                override fun onAdClosed() {
                                    SharePrefUtils.setCheckAdsIMG(this@CreateNewActivity, true)
                                    function = "btnImages"
                                    iconSelected()
                                    TedImagePicker.with(this@CreateNewActivity)
        ...
        binding.btnBackGround.tap {
            LogEven.logEvent(this, "bg_click", Bundle())
                    ...
                    Admob.getInstance().loadAndShowReward(this@CreateNewActivity,
                        ...
                        object : RewardCallback {
                            override fun onEarnedReward(rewardItem: RewardItem?) {
                                ...
                                SharePrefUtils.setCheckAdsBG(this@CreateNewActivity, true)
                                showUiADS()
                                iconSelected()
        ...
        binding.ivIncludeBackGround.ivRest.tap {
            ...
            background = null
            backgroundUri = null
            adapterBackGround.setSelectedPosition(-1)
        ...
        binding.btnSound.tap {
            LogEven.logEvent(this, "sound_click", Bundle())
            if (checkPermission(STORAGE_PERMISSION + RECORD_PERMISSION)) {
                function = "btnSound"
                iconSelected()
                binding.ivSound.root.visibility = View.VISIBLE
            } else {
                showDialogPermission(STORAGE_PERMISSION + RECORD_PERMISSION)
            }
        }
        ...
        binding.ivSound.ivRecord.tap {
            LogEven.logEvent(this, "record_click", Bundle())
            if (!SharePrefUtils.isCheckAdsRecord(this) && SharePrefRemote.get_config(
                ...
                if (adIds.isNotEmpty()) {
                    Admob.getInstance().loadAndShowReward(this@CreateNewActivity,
                        ...
                        object : RewardCallback {
                            override fun onEarnedReward(rewardItem: RewardItem?) {
                                SharePrefUtils.setCheckAdsRecord(this@CreateNewActivity, true)
                                recordSound()
        ...
        binding.ivSound.ivMusic.tap {
            LogEven.logEvent(this, "music_click", Bundle())
                ...
                if (adIds.isNotEmpty()) {
                    Admob.getInstance().loadAndShowReward(this@CreateNewActivity,
                        ...
                        object : RewardCallback {
                            ...
                            override fun onAdClosed() {
                                SharePrefUtils.setCheckAdsMusic(this@CreateNewActivity, true)
                                pickAudioFile()
        ...
        binding.btnText.tap {
            LogEven.logEvent(this, "text_click", Bundle())
            if (!SharePrefUtils.isCheckAdsTEXT(this) && SharePrefRemote.get_config(
                ...
                if (adIds.isNotEmpty()) {
                    Admob.getInstance().loadAndShowReward(this@CreateNewActivity,
                        ...
                        object : RewardCallback {
                            override fun onEarnedReward(rewardItem: RewardItem?) {
                                SharePrefUtils.setCheckAdsTEXT(this@CreateNewActivity, true)
                                showUiADS()
                                function = "btnText"
                                iconSelected()
                                textAlignment()
        ...
        binding.ivIncludeBackGround.ivSave.tap {
            if (backPositon == -1) {
                Log.d("ivIncludeBackGround", "ivIncludeBackGround")
                Toast.makeText(
                    this@CreateNewActivity,
                ...
                if (backPositon == 0) Glide.with(this).load(backgroundUri)
                    ...
                    backgroundUri = null
                    binding.activityCreat.background = getDrawable(backGroungModel.image!!)
                }
                clearIconSelected()
                binding.ivIncludeBackGround.root.visibility = View.GONE
            }
    ...
    private fun saveDiaryEntry() {
        try {
            ...
            val createdAt = selectedTimeInMillis ?: selectedCalendar.timeInMillis
            ...
            val textColor = textColorInt ?: null
            val textFont = selectedFont ?: null
            ...
            lifecycleScope.launch {
                try {
                    ...
                    Toast.makeText(
                        this@CreateNewActivity, R.string.diary_entry_saved, Toast.LENGTH_SHORT
                    ).show()
                    finish()
    ...
    private fun recordSound() {
        ...
        if (window != null) {
            ...
            try {
                if (SharePrefRemote.get_config(
                        this, SharePrefRemote.native_popup
                    ) && AdsConsentManager.getConsentResult(this)
                ) {
                    ...
                    nativeBuilder.setListIdAd(
                        AdmobApi.getInstance().getListIDByName("native_popup")
                    )
    ...
    private fun stopCurrentSound() {
        if (currentPlayingPosition < 0 || currentPlayingPosition >= soundsList.size) {
            return // Không thực hiện gì nếu vị trí không hợp lệ
        }
        ...
        adapterRecord.notifyItemChanged(previousPosition)
    }

    private fun updateSeekBar(position: Int) {
        if (position < 0 || position >= soundsList.size) return
        val sound = soundsList[position]
        countdownTimer?.cancel()
    ...
    private fun backGround(position: Int, backGroudModel: BackGroundModel) {
        Log.d("ivIncludeBackGround", position.toString())
        if (position == 0) {
            if (checkPermission(STORAGE_PERMISSION + CAMERA_PERMISSION)) {
                Log.d("ted", "$position")
    ...
    private fun hastag() {
        if (textColorInt != null) {
            val parsedColor = Color.parseColor(textColorInt)
        ...
        binding.edtAddhastag.setOnEditorActionListener { _, actionId, _ ->
            if (actionId == EditorInfo.IME_ACTION_DONE) {
                ...
                if (hastag.isNotEmpty()) {
                    ...
                    Log.d("adapterHastag", "$textColorInt")
...
//            6
    ...
    private fun textColor() {
        ...
        val items = ItemsProvider.getDefaultColors(newColor)

        adapterTextColor = ColorTextCreatNewAdapter(this, items) { color ->
            ...
            if (color.id == 1) {
                ...
                popUpColorPicker(defaultColor) { selectedColor ->
                    ...
                    adapterTextColor.updateList(items)
                }
            } else {
    ...
    fun popUpColorPicker(defaultColor: Int, onColorPicked: (String) -> Unit) {
