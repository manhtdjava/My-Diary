...
class ChangePasswordSettingActivity : BaseActivity<ActivityEnterPasswordBinding>() {
    ...
    override fun viewListener() {
        ...
        binding.tvNext.tap {
            if (SharePrefUtils.getPassword(this) != passCode) {
                Toast.makeText(this, getString(R.string.title_re_enter), Toast.LENGTH_SHORT).show()
                num1 = ""
                num2 = ""
                num3 = ""
                num4 = ""
                ...
                val intent =
                    Intent(this@ChangePasswordSettingActivity, ChangePasswordActivity::class.java)
        ...
        binding.tvForgot.tap {
            ...
            if (SharePrefRemote.get_config(
                    this@ChangePasswordSettingActivity, SharePrefRemote.inter_password
                ) && InterAdHelper.canShowNextAd(this@ChangePasswordSettingActivity) && AdsConsentManager.getConsentResult(
                    this@ChangePasswordSettingActivity
                )
            ) {
                    InterAdHelper.showListInterAd(
                        this@ChangePasswordSettingActivity, SharePrefRemote.get_config(
                            this@ChangePasswordSettingActivity, SharePrefRemote.inter_password
